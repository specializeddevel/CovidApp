...
class DataDiagnostico {
    companion object{
        ...
        var tieneContactoCovid: Int? = null
        var tosSeca: Int? = null
        var fiebre: Int? = null
        var malestar: Int? = null
        var dolorCabeza: Int? = null
        var dificultadRespirar: Int? = null
        var dolorMuscular: Int? = null
